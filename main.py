...
GAMING_HEADERS_SVODKI = [
    ...
    "📋 [DOTA] Мид проигран, но сводки сами себя не выиграют. Гоу.",
    "📋 [CS2] Дропни AWP и бери бумаги. Время рашить штаб.",
    "📋 [Genshin] Твоя смола на нуле, иди фармить реальные сводки, Путешественник.",
    "📋 [KCD2] Генри пришел навестить нас! А ты иди неси сводки, крестьянин.",
    "📋 [KCD2] Слава Иисусу Христу! И слава дежурному, который щас потащит макулатуру.",
    "📋 Exception in thread 'main': SvodkiNotDeliveredError. Фикси давай.",
    ...
    "📋 [DOTA] Глиф на базу не работает, штаб ждет сводки. Телепортируйся.",
    "📋 [CS2] Флешка в лицо, сводки в руки. Это база, бро.",
    "📋 [Genshin] Катерина ждет отчет о выполненных поручениях. Не ломай вайб.",
    "📋 [KCD2] Дороги Богемии опасны, но штаб страшнее. Неси грамоты.",
    "📋 `sudo rm -rf /lazy` && `donesi_svodki --force`",
    "📋 Пинг 999 не оправдание. Сводки доставляются по протоколу UDP: кинул и забыл.",
    "📋 [DOTA] Сентряки стоят, инвиз не спасет. Иди неси.",
    "📋 [CS2] Контр-террористы победили. Но ты еще должен отнести сводки.",
    "📋 [Genshin] Гача на сегодня: 100% шанс выбить поход со сводками. Скам, но что поделать.",
    "📋 Обнаружена утечка памяти! А, нет, это ты забыл про сводки.",
    "📋 Нажми F, чтобы подобрать сводки. И W, чтобы топать в штаб.",
    "📋 Квест обновлен: доставить макулатуру в точку B. Награда: респект."
]
...
GAMING_HEADERS_PROC = [
    ...
    "🧹 [DOTA] Денай крипов оставим керри. Ты денаишь грязь в процедурке.",
    "🧹 [CS2] Смоки не скроют грязный пол. Бери швабру, это твой дефьюз-кит.",
    "🧹 [Genshin] Бездна обновлена. Этаж 12: Процедурка. Удачи закрыть на 3 звезды.",
    "🧹 [KCD2] Даже в Куттенберге чище! Бери метлу, святой отец.",
    "🧹 [KCD2] Кровь, грязь и шнапс... Отмывай процедурку, пока стража не увидела.",
    "🧹 `git reset --hard HEAD` для процедурки. Откати ее к чистому вайбу.",
    "🧹 Твоя RTX 5070 будет холодной, а вот ты со шваброй сейчас жестко вспотеешь.",
    "🧹 Блок питания на 1000W не спасет от перегрева, когда будешь драить полы.",
    "🧹 [DOTA] Купи дасты, грязь ушла в инвиз. Вычищай процедурку до блеска.",
    "🧹 [CS2] Зачистка сектора! Швабра в руках, углы чекай, чтоб без кринжа.",
    "🧹 [Genshin] Анемо-резонанс не выдует пыль из углов. Работай руками, нормис.",
    "🧹 [KCD2] Чувствую себя голодным... до чистой процедурки! За работу.",
    "🧹 `docker system prune -a` в реальной жизни. Очисть кэш процедурки.",
    "🧹 404 Cleanliness Not Found. Пофикси этот баг до 22:00.",
    "🧹 [DOTA] Саппорт, твое время пришло. Варди процедурку и выноси мусор.",
    "🧹 [CS2] GG WP. Но катка не закончена, пока пол не заблестит как имба.",
    "🧹 [Genshin] Очищение Священной Сакуры — это ничто по сравнению с процедуркой.",
    "🧹 Запускаю garbage collector... Ой, это же ты со шваброй.",
    "🧹 Твой инвентарь перегружен грязью. Выброси лишнее из процедурки.",
    "🧹 Сохранение невозможно, пока поблизости враги (грязь). Зачищай территорию."
]
...
GAMING_ENDINGS = [
    ...
    "пуш мид и иди делай наряд, союзники на тебя надеются 🗡️",
    "это не баг, это фича: наряд существует пока его не выполнят 🐛",
    "commit сделан, тесты зелёные — осталось задеплоить себя на точку 🟢",
    ...
    "катка потная, но ты обязан затащить это в соло 💦",
    "+25 MMR к твоему авторитету в чате 📈",
    "сделай всё без кринжа, не руинь вайб коллектива 🤙",
    "pull request на отдых будет апрувнут только после наряда 💻",
    "выиграй эти 50/50 у своей лени, сигма 🎲",
    "сохранись шнапсом и иди делай. переигровки не будет 🍺",
    "FPS в норме, пинг нулевой — отмазок больше нет 🖥️",
    "это абсолютная база, делай и свободен 🗿",
    "не будь скуфом, закрой таску как гигачад 💪",
    "тимейты готовы кинуть репорт, если не пойдёшь прямо сейчас ⚠️",
    "закрыл таску быстрее, чем индус со StackOverflow. заранее респект 🇮🇳",
    "босс этой локации ждёт. лутай волю в кулак и вперёд 👹",
    "твой билд на дежурного работает. не фидь 🛡️",
    "VAC-бан за прокрастинацию уже на подходе, шевелись ⛔",
    "Архонты смотрят на тебя с осуждением, пока ты сидишь 👁️",
    "курьер доставит тебе респект, как только закончишь 🐴",
    "байбек не понадобится, если не сольёшься прямо сейчас 💰",
    "Бог с тобой, Генри! Но наряд сам себя не сделает 🗡️",
    "квест почти сдан, осталось только дойти ножками 🗺️",
    "ни одного дропнутого пакета, соединение установлено 🌐",
    "код жизни скомпилировался без ошибок. иди выполняй ⚙️",
    "выдай имбу, чтобы все в чате офигели 🤯",
    "дефьюз китов нет, времени в обрез — раш до конца 💣",
    "лутай экспу за дейлик, пока сервер не упал 📉",
    "Paimon уже приготовила сковородку, если ты не пойдёшь 🍳",
    "просто сигма-мув: встал, сделал, ушёл в закат 🐺",
    "твой термоинтерфейс ещё свежий, не перегреешься. топай ❄️",
    "закрывай гештальт и иди чиль, дед инсайд 🥀",
    "это не сайд-квест, это мейн стори. скипнуть не выйдет 📜",
    "твоя репутация в штабе висит на волоске. действуй ⚖️"
]
...
EASTER_EGGS = [
    ...
    # ---- 40 НОВЫХ ПАСХАЛОК ----
    # IT и кодинг
    lambda person, duty: f"🔥 *JIRA: CRITICAL BUG*\n\n**Assignee:** {person}\n**Task:** {'Сводки' if duty=='svodki' else 'Процедурка'}\n**Status:** 🔴 TO DO\n**Comments:** Бля, {person}, фикси срочно, у нас прод лежит. Спринт горит нахуй!",
    lambda person, duty: f"🟦 *CRITICAL_PROCESS_DIED*\n\nВаша смена столкнулась с проблемой и нуждается в {'сводках' if duty=='svodki' else 'уборке'}.\nСбор информации об ошибке: 100%\nКод остановки: {person.upper()}_IS_LAZY\n\nДавай, ебать, вставай и фикси это.",
    lambda person, duty: f"🐙 *GITHUB ALERTS*\n\n`git blame {person}`\nНайден кринж-коммит: `ignored {'svodki' if duty=='svodki' else 'procedura'}`.\nСделай `git push --force` своих ног в сторону задачи, пока техлид не дал пизды.",
    lambda person, duty: f"🐍 *PYTHON TRACEBACK*\n\n```python\nTraceback (most recent call last):\n  File \"{person}_life.py\", line 404, in <module>\n    do_{'svodki' if duty=='svodki' else 'procedura'}()\nLazyError: {person} refuses to move.\n```\nФикси этот кринж, пока сервер не лег.",
    lambda person, duty: f"🗄️ *SQL INJECTION*\n\n`UPDATE duties SET status='DONE' WHERE person='{person}' AND task='{'svodki' if duty=='svodki' else 'procedura'}';`\n\nQuery OK, 0 rows affected. Хули стоим? База сама себя не обновит.",
    lambda person, duty: f"🌐 *502 BAD GATEWAY*\n\nСервер {person} перестал отвечать на запросы по {'сводкам' if duty=='svodki' else 'процедурке'}.\nПопробуйте ебнуть по серверу физически или заставить его работать.",
    lambda person, duty: f"📉 *CRYPTO ALERT*\n\nТокен ${person.upper()} обвалился на 99%!\nИнвесторы в панике, потому что фаундер забил на {'сводки' if duty=='svodki' else 'процедурка'}.\nДелай rug pull или пиздуй отрабатывать долги, скамер.",
    lambda person, duty: f"🐳 *DOCKER COMPOSE*\n\n`docker-compose up -d {person}`\nError: Container {person} exited with code 1 (LazyBoyException).\nПерезапусти контейнер и выполни `/{'svodki' if duty=='svodki' else 'procedura'}.sh`, блять.",
    lambda person, duty: f"🛡️ *VPN DISCONNECTED*\n\nТвой айпишник спален. Товарищ майор уже знает, что {person} хуй забил на {'сводки' if duty=='svodki' else 'процедурку'}.\nРекомендуем срочно выполнить задачу для обфускации трафика.",
    lambda person, duty: f"📡 *PING {person}*\n\nRequest timeout for icmp_seq 0\nRequest timeout for icmp_seq 1\n\nАлло, ебать, пакеты теряются! {'Сводки' if duty=='svodki' else 'Процедурка'} сама себя не смаршрутизирует!",

    # Гейминг
    lambda person, duty: f"🐉 *SKYRIM*\n\nЭй, {person}, ты не спишь? Ты нарушил закон Скайрима и ее народа!\nТвое наказание — {'сводки' if duty=='svodki' else 'процедурка'}.\nЧто скажешь в свою защиту? Да похуй, бери и делай.",
    lambda person, duty: f"📻 *PIP-BOY 3000*\n\n**Квест добавлен:** {'Затерянные в сводках' if duty=='svodki' else 'Чистота пустоши'}\n**Цель:** {person}\nРадиация растет, ебать. Надевай силовую броню и пиздуй выполнять, житель Убежища.",
    lambda person, duty: f"🦾 *CYBERPUNK 2077*\n\nВставай, самурай {person}. У нас есть {'сводки, которые нужно сжечь' if duty=='svodki' else 'процедурка, которую нужно убрать'}.\nИмпланты не помогут, тут надо ручками, ебана.",
    lambda person, duty: f"🐺 *ВЕДЬМАК 3*\n\nВетер воет... А это значит, что {person} должен делать {'сводки' if duty=='svodki' else 'процедурку'}.\nСеребряный меч — для монстров. Стальной — для людей.\nА швабра и бумажки — для тебя. Вперед, бля.",
    lambda person, duty: f"💍 *ELDEN RING*\n\nFOE SLAIN? Нихуя подобного.\nТвой главный босс на сегодня — {'Сводки Радагона' if duty=='svodki' else 'Маления, Клинок Процедурки'}.\nТвои перекаты не спасут, {person}. Иди страдай.",
    lambda person, duty: f"🪖 *ESCAPE FROM TARKOV*\n\n{person}, дикие уже на подходе. \nХватай {'сводки' if duty=='svodki' else 'ведро с тряпкой'} и дуй на выход (extract). \nПотеряешь лут — получишь пизды от Терапевта.",
    lambda person, duty: f"⚔️ *WORLD OF WARCRAFT*\n\n{person}, твой рейд собирается у входа в {'Штаб Сводок' if duty=='svodki' else 'Подземелье Процедурки'}.\nТы танк, хули ты слакаешь в Даларане? Бафайся и гоу, у нас вайп намечается.",
    lambda person, duty: f"🚁 *GTA SAN ANDREAS*\n\nAh shit, here we go again.\n{person}, всё, что тебе, блять, нужно было сделать — это {'отнести эти чертовы сводки' if duty=='svodki' else 'убрать эту чертову процедурку'}, Си-Джей!",
    lambda person, duty: f"⛏️ *MINECRAFT*\n\n{person} was slain by {'Сводки' if duty=='svodki' else 'Процедурка'}.\nRespawn?\nTitle screen?\nНикакого респавна, пока не добудешь алмазы и не закроешь этот наряд.",
    lambda person, duty: f"🔪 *AMONG US*\n\nВнимание!\n{person} sus. Я видел, как он фейкал таску «{'Сводки' if duty=='svodki' else 'Процедурка'}» в электрике.\nВыполняй давай, или выкинем в шлюз нахуй.",
    lambda person, duty: f"🩸 *DOOM*\n\nRIP AND TEAR, {person}, UNTIL IT IS DONE.\nДемоны захватили {'сводки' if duty=='svodki' else 'процедурку'}. Бери BFG (Большую Факинг Швабру) и устрой им кровавую баню.",

    # Зумерский сленг и интернет-культура
    ...
    lambda person, duty: f"🟪 *TWITCH CHAT*\n\nuser123: LMAO {person} опять руинит 🤡\ngigachad_00: KEKW скипает {'сводки' if duty=='svodki' else 'процедурку'}\nsigma_bot: F в чат за {person}\n\nНе позорься перед чатом, блять, иди делай.",
    lambda person, duty: f"📱 *POV*\n\nТы — {person}. Ты думал, что сможешь почиллить, но вспомнил про {'сводки' if duty=='svodki' else 'процедурку'}.\nВайб испорчен. Трек играет на минус вайб. \nСнимай титок про дединсайда и иди батрачь.",
    lambda person, duty: f"✨ *АСТРОЛОГИЧЕСКИЙ ПРОГНОЗ*\n\nМеркурий в ретрограде. Для {person} это значит только одно: тотальный пиздец со {'сводками' if duty=='svodki' else 'процедуркой'}.\nТвоя аура требует очищения через физический труд. Намасте, бля.",
    lambda person, duty: f"🔥 *TINDER MATCH*\n\nУ тебя новый мэтч, {person}!\nЕё зовут: {'Сводки' if duty=='svodki' else 'Процедурка'}.\nРасстояние: Прямо перед твоим носом.\nИнтересы: Выебать тебе мозг. \nИди на свидание, скуф.",
    lambda person, duty: f"🧠 *ШИТПОСТ*\n\nникто:\nабсолютно никто:\n{person}: *пытается задоджить {'сводки' if duty=='svodki' else 'процедурку'}*\nя: это кринж, бро. абсолютный анваб. иди делай.",
    lambda person, duty: f"🎙️ *ASMR ROLEPLAY*\n\n*шепотом*\nПривет, {person}... Я сейчас буду медленно шуршать бумажками... это твои {'сводки' if duty=='svodki' else 'тряпки для процедурки'}...\nЧувствуешь мурашки? Это пиздец подкрадывается, если не пойдешь.",
    lambda person, duty: f"🏋️ *GYM BRO*\n\nЙоу, {person}, легкие веса, детка! LIGHT WEIGHT BABY!\n{'Сводки' if duty=='svodki' else 'Процедурка'} — это твоя база, твоя становая тяга на сегодня.\nНе пропускай день наряда, ебашь в отказ!",
    lambda person, duty: f"▶ 🔘──────── 0:14\n\nБля, {person}, короче... *вздох*... ну это пиздец. Ты типа вообще собираешься {'сводки нести' if duty=='svodki' else 'процедурку убирать'} или как? Давай не душни, просто сделай и всё, вайб не ломай.",

    # Абсурд и кино
    lambda person, duty: f"☢️ *SCP FOUNDATION*\n\n**Объект:** SCP-{random.randint(1000, 9999)} \"{person}\"\n**Класс:** Кетер\n**Условия содержания:** Субъект должен ежедневно выполнять {'сводки' if duty=='svodki' else 'процедурку'}, иначе произойдет конец света класса XK.\nПротокол активирован. Не проебись.",
    lambda person, duty: f"🦉 *ПИСЬМО ИЗ ХОГВАРТСА*\n\nМистер {person},\nМы рады сообщить, что вы приняты на факультет Дежурных.\nВаше заклинание на сегодня: {'Сводкио Отнесито' if duty=='svodki' else 'Процедуро Убиратус'}.\nПалочку в зубы и вперед, блять, магия сама не сработает.",
    lambda person, duty: f"🕴️ *КОЗА НОСТРА*\n\nДон передает тебе привет, {person}.\nОн просил напомнить про {'сводки' if duty=='svodki' else 'процедурку'}. \nСделай это красиво, или завтра ты проснешься с головой лошади. Капиш?",
    lambda person, duty: f"📺 *СРОЧНЫЕ НОВОСТИ*\n\nЭкстренный выпуск! {person} до сих пор не сделал {'сводки' if duty=='svodki' else 'процедурку'}.\nРынки рушатся, начинается паника! Спасет ли он этот день? Узнаем после рекламы (нет, иди делай блять).",
    lambda person, duty: f"⏱️ *ПОСЛАНИЕ ИЗ БУДУЩЕГО*\n\n{person}! Я — это ты из 2050 года!\nЕсли ты сейчас не сделаешь {'сводки' if duty=='svodki' else 'процедурку'}, временной континуум схлопнется и мы станем скуфами!\nБлять, спасай нас, делай наряд!",
    lambda person, duty: f"🌸 *ANIME MOMENT*\n\n{person}-кун! (⁄ ⁄>⁄ ▽ ⁄<⁄) ⁄\nЯмато-сенсей сказал, что если ты не сделаешь {'сводки' if duty=='svodki' else 'процедурку'}... он сделает тебе харакири!\nТаттакаэ, {person}, таттакаэ! Нахуй лень!",
    lambda person, duty: f"🥠 *ПЕЧЕНЬЕ С ПРЕДСКАЗАНИЕМ*\n\n«Тот, кто откладывает {'сводки' if duty=='svodki' else 'процедурку'}, обретет лишь геморрой и пиздюли» — Лао Цзы, 4 век до н.э.\nМудрость предков не оспоришь, {person}.",
    lambda person, duty: f"🤡 *ПИЛА*\n\nЯ хочу сыграть с тобой в игру, {person}.\nВ твоем теле яд. Противоядие находится в {'стопке сводок' if duty=='svodki' else 'ведре для процедурки'}.\nУ тебя есть 10 минут. Выбор за тобой.",
    lambda person, duty: f"📁 *СОВ. СЕКРЕТНО*\n\nТоварищ {person}. Партия разочарована вашим саботажем операции «{'Сводки' if duty=='svodki' else 'Процедурка'}».\nЕсли задача не будет выполнена в срок, вас ждет путевка в Сибирь. Выполнять, блять!"
]
...
async def cmd_start(message: types.Message):
    ...
    start_text = (
        ...
        "🎵 *Пиздить музыку:* напиши `/find <название>`, и я скачаю тебе mp3-шку в отличном качестве.\n"
