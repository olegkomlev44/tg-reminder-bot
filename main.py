...
async def cmd_start(message: types.Message):
    ...
    start_text = (
        ...
        "☁️ *Погода:* напиши `/pogoda` или `/pogoda Москва` — чекну погоду в любом городе, чтоб ты не откинулся от холода.\\n"
        "📸 *Instagram Viewer:* `/ig <username>` — анонимно смотри истории и посты, подписка на уведомления.\n"
        "📥 *Скачать видео:* кинь ссылку с YouTube / TikTok / Twitter / Reddit — скачаю и пришлю файлом. Или `/dl <ссылка>`.\n"
