...
#  СПИСКИ ДЕЖУРНЫХ
# ══════════════════════════════════════════════
SVODKI_LIST    = ["Олег", "Максим", "Руслан", "Игорь", "Илья", "Глеба", "Ильнар"]
...
AI_SYSTEM_PROMPT = (
    ...
    "ОБЯЗАТЕЛЬНО используй органичный разговорный мат (блять, ебать, пиздец, нахуй, хуйня), как будто базаришь с кентами в Доте или КСе. "
