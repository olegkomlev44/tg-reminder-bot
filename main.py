...
#  СПИСКИ ДЕЖУРНЫХ
# ══════════════════════════════════════════════
SVODKI_LIST    = ["Глеб", "Денис", "Арсений", "Олег", "Максим", "Руслан", "Игорь", "Ильнар"]
PROCEDURA_LIST = ["Глеб", "Руслан","Денис", "Игорь", "Ильнар"]
...
def build_duty_message(target_date, label):
    ...
    # Добавляем бригаду врачей, если сейчас ИЮЛЬ (7 месяц)
