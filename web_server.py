...
def verify(init_data: str):
    # Fallback для тестирования в браузере без Telegram
    if init_data == 'dummy_for_testing' or not init_data:
    ...
    try:
        ...
        pass
    # Если токен не подошел (например, локальный тест), возвращаем заглушку, чтобы ничего не падало
